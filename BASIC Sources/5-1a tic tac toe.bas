0 IF CLEARMEM=1 THEN GOTO 50
1 CLEARMEM=1
2 LOAD"CLEAR MEMORY",8,1
5 :::::::::::::::::::::::::::::::::::::
...
60 POKE 251,0 : POKE 252,64 : REM START ADDR 0X4000
61 POKE 253,237 : POKE 254,140 : REM END ADDR 0X8CED
62 SYS 49152 : REM CLEAR MEMORY
70 G=0
80 G=G+1:T=0
